...
export class BoardController {
  static validateSyncOrCreate = (request: FastifyRequest<any>, reply: FastifyReply<any>) => {
    const schema = getJoi()
      .object()
      .keys({
        id: getJoi()
  ...
  static createBoard: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
  ...
  static getBoards: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
    // nothing to validate
  ...
  static getBoard: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
    const board = await BoardRepository.getBoard(request.params.boardId)
    return ResponseHelper.create(request, reply, board)
  }

  static syncBoard: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
    const validation = BoardController.validateSyncOrCreate(request, reply)
    if (validation !== true) {
      return validation
    }
  ...
  static addUserToBoard: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
  ...
  static removeUserFromBoard: DefaultRequestHandler<any, BoardCommonParam> = async (request, reply) => {
    const validation = BoardController.validateAction(request, reply)
    if (validation !== true) {
      return validation
    }
